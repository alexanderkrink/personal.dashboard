...
const COPY: Record<string, { subject: string; heading: string; body: string; cta: string }> = {
  signup: {
    subject: "Confirm your email · StudyOS",
    heading: "Confirm your email",
    body: "Follow the link below to confirm your email address and sign in to StudyOS.",
    cta: "Confirm and sign in",
  },
  magiclink: {
    subject: "Your sign-in link · StudyOS",
    heading: "Sign in to StudyOS",
    body: "Follow the link below to sign in. This link can only be used once.",
    cta: "Sign in to StudyOS",
  },
  recovery: {
    subject: "Reset your password · StudyOS",
    heading: "Reset your password",
    body: "Follow the link below to reset your password.",
    cta: "Reset password",
  },
  email_change: {
    subject: "Confirm your new email · StudyOS",
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:440px;background-color:#ffffff;border-radius:12px;border:1px solid #e5e5e5;padding:32px;">
            <tr><td style="font-size:20px;font-weight:600;color:#171717;padding-bottom:8px;">StudyOS</td></tr>
            ...
            <tr>
              <td style="padding-bottom:24px;">
                <a href="${url}" style="display:inline-block;background-color:#171717;color:#ffffff;font-size:14px;font-weight:500;text-decoration:none;padding:10px 20px;border-radius:8px;">${copy.cta}</a>
              </td>
            </tr>
